...
_dynapyt_ast_ = "/home/liln/23w_program_analysis/myproject/Dynamic_Slicing_DynaPyt/tests/milestone3/test_5/program.py" + ".orig"
try:
    def slice_me():
        ...
        return _rt._read_(_dynapyt_ast_, 17, lambda: ages) # slicing criterion
